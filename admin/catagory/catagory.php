        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Catagory <a href="./add.php" class="btn btn-info btn-xs">Add</a></h3>
                ...
                <tbody>
                  <?php foreach ($catagorys as $i => $catagory) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="./update.php?id=<?php echo $catagory['catagory_id'] ?>" class="btn btn-info btn-xs">Update</a>
